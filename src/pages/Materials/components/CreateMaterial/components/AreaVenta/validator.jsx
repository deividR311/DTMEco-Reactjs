...
export const validateError = (value, options) => ({
  salesOrganization: validateArray(options["salesOrganizationDistributionChannelList"]),
  distributionChannel: validateArray(options["salesOrganizationDistributionChannelList"])
});